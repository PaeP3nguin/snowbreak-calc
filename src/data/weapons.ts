  ...
  [WeaponType.SMG]: [
    {
      ...
      modifiers: [
        {
          active: true,
          name: 'Uninvited Adieu passive (T1)',
          description: '',
          type: ModifierType.ElementalDamage,
          element: ElementType.Chaos,
          value: 18,
        ...
        {
          active: false,
          name: 'Uninvited Adieu passive (T2)',
          description: '',
          type: ModifierType.ElementalDamage,
          element: ElementType.Chaos,
          value: 30,
        },
        {
          ...
          name: 'Uninvited Adieu passive (T1)',
          description:
            'Increases damage taken from Dazed by 6%, plus 1.2% per stack when dealing damage, up to 20s.',
          type: ModifierType.DamageTaken,
          element: ElementType.Chaos,
          value: 30,
          target: 'DoT',
        },
        {
          ...
          name: 'Uninvited Adieu passive (T2)',
          description:
            'Increases damage taken from Dazed by 10%, plus 2% per stack when dealing damage, up to 20s.',
          type: ModifierType.DamageTaken,
          element: ElementType.Chaos,
          value: 50,
          target: 'DoT',
        },
        {
          active: true,
          name: 'Uninvited Adieu passive (T1)',
          description: 'When at max stacks, increase ATK by 18%',
          type: ModifierType.AtkPercent,
          value: 18,
        },
        {
          active: false,
          name: 'Uninvited Adieu passive (T2)',
          description: 'When at max stacks, increase ATK by 30%',
          type: ModifierType.AtkPercent,
          value: 30,
        },
      ],
    },
    {
      ...
      modifiers: [
        {
          active: true,
          name: '100 Battle Vet passive (T1)',
          description: '',
          type: ModifierType.AtkPercent,
          value: 18,
        },
        {
          ...
          name: '100 Battle Vet passive (T1)',
          description:
            'Ballistic DMG increases linearly with fewer bullets in magazine, max 42% for an average of 21%',
          type: ModifierType.BallisticDamage,
          value: 21,
        },
        {
          active: false,
          name: '100 Battle Vet passive (T2)',
          description: '',
          type: ModifierType.AtkPercent,
          value: 30,
        },
        {
          ...
          name: '100 Battle Vet passive (T2)',
          description:
            'Ballistic DMG increases linearly with fewer bullets in magazine, max 70% for an average of 35%',
          type: ModifierType.BallisticDamage,
          value: 35,
        },
      ],
    ...
    },
    {
      ...
      modifiers: [
        {
          active: true,
          name: 'Halo of Hope passive (T5)',
          description:
            'For each Dazed stack, increase damage dealt to the target by 2%, max 20 stacks',
          type: ModifierType.Generic,
          value: 40,
        },
        {
          active: false,
          name: 'Halo of Hope passive (T1)',
          description:
            'For each Dazed stack, increase damage dealt to the target by 1.2%, max 20 stacks',
          type: ModifierType.Generic,
          value: 24,
        },
      ],
    ...
    },
    {
      ...
      skillDamage: [
        {
          name: 'Work-in-Progress passive (T5)',
          description:
            'Hitting an enemy deals 42% ATK of damage in an AoE, 5s CD.',
          active: false,
          element: ElementType.Electrical,
          damagePercent: 42,
          damageFlat: 0,
        ...
        },
        {
          name: 'Work-in-Progress passive (T5)',
          description:
            'Hitting an enemy deals 70% ATK of damage in an AoE, 5s CD.',
          active: true,
          element: ElementType.Electrical,
          damagePercent: 70,
          damageFlat: 0,
  ...
  [WeaponType.Pistol]: [
    {
      ...
      skillDamage: [
        {
          name: 'Star Ocean passive skill (T1)',
          description:
            'When an active skill hits a target, deals Kinetic DMG equal to 9% ATK every 0.5s for 3s. The damage procs immediately on the initial hit, so add another skill DPS source if using multihit skills like Redacted.',
          active: true,
          element: ElementType.Kinetic,
          damagePercent: 9,
          damageFlat: 0,
        ...
        {
          name: 'Star Ocean passive skill (T2)',
          description:
            'When an active skill hits a target, deals Kinetic DMG equal to 15% ATK every 0.5s for 3s. The damage procs immediately on the initial hit, so add another skill DPS source if using multihit skills like Redacted.',
          active: false,
          element: ElementType.Kinetic,
          damagePercent: 15,
          damageFlat: 0,
    ...
    },
    {
      ...
      modifiers: [
        {
          active: false,
          name: 'Nexus passive (T1)',
          description: 'Increases skill DMG by 6% per second. Max 6 stacks.',
          type: ModifierType.SkillDamage,
          value: 36,
        },
        {
          active: true,
          name: 'Nexus passive (T5)',
          description: 'Increases skill DMG by 6% per second. Max 10 stacks.',
          type: ModifierType.SkillDamage,
          value: 60,
        },
      ],
